...
var _ = Describe("RRSet", func() {
	var (
		...
		soa1   = MustNewRR("example.jp. IN SOA localhost. root.localhost. 1 3600 600 86400 900")
		soa2   = MustNewRR("example.jp. IN SOA localhost. root.localhost. 2 3600 600 86400 900")
		cname1 = MustNewRR("example.jp. IN CNAME www1.example.jp.")
		cname2 = MustNewRR("example.jp. IN CNAME www2.example.jp.")
	)
